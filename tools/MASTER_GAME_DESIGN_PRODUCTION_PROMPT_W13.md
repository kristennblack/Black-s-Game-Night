...
# MASTER GAME DESIGN + PRODUCTION DIRECTIVE W.13
## Cabin Rooms, Collections, Game Night Tokens + persistent family-history meta-game
...
W.13 is a design/catalog/foundation release. It does not falsely identify the unchanged W.12 gameplay runtime as a completed Cabin Rooms runtime. Where W.13 discusses cabin rooms, collections, token economy, gifts, room ownership, visiting or room rewards, W.13 supersedes older W.8 token-store language. W.12 remains authoritative for its gameplay corrections, W.11 for Prop Hunt stability, W.10 for professional production discipline, and approved family-character locks remain mandatory.
...
3. W.13 Cabin Rooms / Collections directive and 400-item catalog.
4. W.12 gameplay corrections.
5. W.11 Prop Hunt smoothness/stability.
6. W.10 professional production framework.
7. Non-conflicting older directives.
8. Historical prototypes/obsolete implementation details.

Authoritative W.13 catalog: `CABIN_ROOMS_400_ITEM_MASTER_CATALOG_W13.xlsx`.
Authoritative machine-readable item data: `CABIN_ROOM_ITEM_CATALOG_W13.json` and `public/cabin-room-catalog.mjs`.

======================================================================
PART A — W.13 CABIN ROOMS + COLLECTIONS
======================================================================
