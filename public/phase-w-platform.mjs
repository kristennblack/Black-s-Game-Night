...
const GAMES={
 ...
 'kelsis-rock-hunt':{id:'kelsis-rock-hunt',person:'kelsi',name:'Kelsi',reaction:'Important rock acquired.'},
 ...
 'space-shooter':{id:'space-shooter',name:'Neon Star Patrol',reaction:'Sector clear.'},
