...
## Cloudflare
This package is purpose-built for Cloudflare Workers + a SQLite-backed Durable Object. See `GITHUB_CLOUDFLARE_GUIDE.txt` for the computer-friendly launch steps.

## Tests
Run `node --test` to execute the full test suite. Final package result: 79/79 passing on 2026-08-21.
