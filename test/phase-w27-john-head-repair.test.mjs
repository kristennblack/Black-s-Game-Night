...
test('W27 release identity and cache isolation are current',()=>{
 ...
 assert.match(sw,/PHASE_W27_CACHE='black-family-game-night-staging-phase-w27-john-head-repair-52'/);assert.match(sw,/const CACHE=PHASE_W30_CACHE/);assert.match(sw,/w27-john-head-fit-lab\.html/);assert.match(sw,/w27-character-wearable-runtime\.mjs/);
