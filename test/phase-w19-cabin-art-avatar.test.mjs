...
const W22='GAME-NIGHT-STAGING-PHASE-W23-CATALOG-FIT-ACCESSORIES-45';
...
test('W19 and W21 identities remain historical while W22 is current',()=>{
  ...
  assert.equal(JSON.parse(read('package.json')).version,'3.21.0-staging-phase-w23-catalog-fit-accessories-45');
