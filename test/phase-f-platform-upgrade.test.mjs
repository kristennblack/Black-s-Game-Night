...
test('Phase F platform build ID and cache namespace are explicit and fresh',async()=>{
  ...
  assert.match(app,/GAME-NIGHT-STAGING-PHASE-O-REALISTIC-ACTIONS-12/);assert.match(sw,/black-family-game-night-staging-phase-o-realistic-actions-12/);assert.match(qa,/GAME-NIGHT-STAGING-PHASE-O-REALISTIC-ACTIONS-12/);assert.equal(version.trim(),'GAME-NIGHT-STAGING-PHASE-O-REALISTIC-ACTIONS-12');
});
