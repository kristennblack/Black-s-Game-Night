...
test('Phase F platform build ID and cache namespace are explicit and fresh',async()=>{
  ...
  assert.match(app,/GAME-NIGHT-STAGING-PHASE-I-THREE-GAMES-07/);assert.match(sw,/black-family-game-night-staging-phase-i-three-games-07/);assert.match(qa,/GAME-NIGHT-STAGING-PHASE-I-THREE-GAMES-07/);assert.equal(version.trim(),'GAME-NIGHT-STAGING-PHASE-I-THREE-GAMES-07');
});
