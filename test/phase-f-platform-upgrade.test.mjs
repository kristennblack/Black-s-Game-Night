...
test('Phase F platform build ID and cache namespace are explicit and fresh',async()=>{
  ...
  assert.match(app,/GAME-NIGHT-STAGING-PHASE-P1-FLAGSHIP-UPGRADE-14/);assert.match(sw,/black-family-game-night-staging-phase-p1-flagship-upgrade-14/);assert.match(qa,/GAME-NIGHT-STAGING-PHASE-P1-FLAGSHIP-UPGRADE-14/);assert.equal(version.trim(),'GAME-NIGHT-STAGING-PHASE-P1-FLAGSHIP-UPGRADE-14');
});
