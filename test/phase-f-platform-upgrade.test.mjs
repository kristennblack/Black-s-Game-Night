...
test('Phase F platform build ID and cache namespace are explicit and fresh',async()=>{
  ...
  assert.match(app,/GAME-NIGHT-STAGING-PHASE-U2-ARCADE-PACK-22/);assert.match(sw,/black-family-game-night-staging-phase-u2-arcade-pack-22/);assert.match(qa,/GAME-NIGHT-STAGING-PHASE-U2-ARCADE-PACK-22/);assert.equal(version.trim(),'GAME-NIGHT-STAGING-PHASE-U2-ARCADE-PACK-22');
});
