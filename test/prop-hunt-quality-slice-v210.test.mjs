...
test('quality slice keeps deliberate third-person framing, navigation and an opt-in phone QA HUD',()=>{
  for(const token of ['cameraDistance:4.35','aimDistance:3.25','minCameraDistance:1.40','maxPitch:.25','groundAccel:25','groundBrake:34','jogSpeed:3.35','sprintSpeed:5.70'])assert.ok(gameplay.includes(token),token);
