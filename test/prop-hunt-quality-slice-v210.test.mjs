...
test('quality slice keeps deliberate third-person framing, navigation and an opt-in phone QA HUD',()=>{
  for(const token of ['cameraDistance:4.65','aimDistance:3.05','minCameraDistance:1.35','groundAccel:16.5','groundBrake:21'])assert.ok(gameplay.includes(token),token);
