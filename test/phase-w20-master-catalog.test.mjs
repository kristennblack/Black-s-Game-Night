...
const W22='GAME-NIGHT-STAGING-PHASE-W22-CATALOG-APPROVAL-STUDIO-44';
...
test('W20 catalog milestone remains preserved while W22 is current',()=>{
  ...
  assert.equal(JSON.parse(read('package.json')).version,'3.20.0-staging-phase-w22-catalog-approval-studio-44');
