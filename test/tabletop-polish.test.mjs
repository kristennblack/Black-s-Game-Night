...
test('Lodge home and connection screen are birthday cabin themed',()=>{for(const t of ['approved-home-scene','approved-fire','home-cabin-approved.png','cabin-loading'])assert.ok(app.includes(t)||css.includes('.'+t));});
