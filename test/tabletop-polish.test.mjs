...
test('Lodge home and connection screen are birthday cabin themed',()=>{for(const t of ['lodge-hero','home-john-feature'])assert.ok(app.includes(t));for(const t of ['.home-firelight','home-cabin-background.jpg','.cabin-loading'])assert.ok(css.includes(t),t);});
