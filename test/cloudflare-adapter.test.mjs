...
test('Launch assets advertise the Phase E staging build and use a fresh service-worker cache', async()=>{
  ...
  assert.match(appSource,/APP_VERSION='GAME-NIGHT-STAGING-PHASE-L-NEW-GAMES-SHELF-09'/);
  assert.match(swSource,/black-family-game-night-staging-phase-l-new-games-shelf-09/);
});
