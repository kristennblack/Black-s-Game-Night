...
test('Launch assets advertise the Phase E staging build and use a fresh service-worker cache', async()=>{
  ...
  assert.match(appSource,/APP_VERSION='GAME-NIGHT-STAGING-PHASE-G-PAPA-VSLICE-05'/);
  assert.match(swSource,/black-family-game-night-staging-phase-g-papa-vslice-05/);
});
