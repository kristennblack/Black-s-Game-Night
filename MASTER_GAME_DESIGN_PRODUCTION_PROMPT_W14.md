...
# MASTER GAME DESIGN + PRODUCTION DIRECTIVE W.14
## Realistic Cabin Rooms, Pristine Catalog Presentation, and Premium Decor Visual Target
...
Visual target release: `GAME-NIGHT-DESIGN-PHASE-W14-REALISTIC-CABIN-ROOMS`

W.14 supersedes W.13 anywhere cabin rooms, the cabin overview, the room decorator, the item catalog, or room furnishing visual quality are discussed. W.14 locks the target look and quality bar to a much more realistic, pristine, premium-cabin presentation rather than flat prototype panels. W.12 remains authoritative for gameplay corrections, W.11 for Prop Hunt stability, W.10 for professional production discipline, and approved family-character locks remain mandatory.
...
3. W.14 Realistic Cabin Rooms premium-visual directive.
4. W.13 Cabin Rooms / Collections directive and 400-item catalog.
5. W.12 gameplay corrections.
6. W.11 Prop Hunt smoothness/stability.
7. W.10 professional production framework.
8. Non-conflicting older directives.
9. Historical prototypes/obsolete implementation details.

Authoritative W.13 catalog remains: `CABIN_ROOMS_400_ITEM_MASTER_CATALOG_W13.xlsx`.
W.14 adds the authoritative visual target and presentation standard for that catalog and the associated room systems.

======================================================================
PART A — W.14 REALISTIC CABIN ROOMS VISUAL TARGET
======================================================================
...
======================================================================
PART B — W.13 CONTENT CARRIED FORWARD
======================================================================
